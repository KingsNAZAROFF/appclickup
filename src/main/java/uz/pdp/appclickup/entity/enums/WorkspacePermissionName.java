...
public enum WorkspacePermissionName {
    ...
    CAN_ADD_MEMBER("CAN_ADD_MEMBER",
            ...
            Arrays.asList(WorkspaceRoleName.WORKSPACE_ROLE_OWNER, WorkspaceRoleName.WORKSPACE_ROLE_ADMIN)
    ),
    ...
    CAN_MANAGE_TAGS("CAN_MANAGE_TAGS",
            "Gives the user the permission to remove members to the Workspace",
            Arrays.asList(WorkspaceRoleName.WORKSPACE_ROLE_OWNER, WorkspaceRoleName.WORKSPACE_ROLE_ADMIN, WorkspaceRoleName.WORKSPACE_ROLE_MEMBER)
    ),
    CAN_SHARE("CAN_SHARE",
            "Gives the user the permission to remove members to the Workspace",
            Arrays.asList(WorkspaceRoleName.WORKSPACE_ROLE_OWNER, WorkspaceRoleName.WORKSPACE_ROLE_ADMIN, WorkspaceRoleName.WORKSPACE_ROLE_MEMBER)
